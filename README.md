...
def add_element_to_start_of_array(arry, element) 
  arry << element
...
def remove_element_from_end_of_array(arry, element) 
...
def remove_element_from_start_of_array(arry)
 arry.pop
end
...
def retrieve_element_from_index(arry)
 arry.shift
end
...
def retrieve_first_element_from_array(arry, index) 
  arry[index]
end 
